...
namespace Fintrak.Client.Core.Proxies
{
    ...
    public class ExtractionProcessClient : UserClientBase<IExtractionProcessService>, IExtractionProcessService
    {
        ...
        public UploadStatus UpdateUploadStatus(UploadStatus upload) {
            return Channel.UpdateUploadStatus(upload);
        }

        public void DeleteUploadStatus(int uploadId) {
            Channel.DeleteUploadStatus(uploadId);
        }

        public UploadStatus GetUploadStatus(int uploadId) {
            return Channel.GetUploadStatus(uploadId);
        }

        public UploadStatus[] GetAllUploadStatuss() {
            return Channel.GetAllUploadStatuss();
        }
        ...
        #region BuildOptionParams

        public KeyvalueModel[] BuildOptionParams(int optioncode){
            return Channel.BuildOptionParams(optioncode);
        }
        ...
        public string ProcessRunJob(int id){
            return Channel.ProcessRunJob(id);
        }
