...
{
    public class OdLgdComputationResult : ObjectBase
    {
        int _Id;
        string _AccountNo;
        string _Refno;
        ...
        class OdLgdComputationResultValidator : AbstractValidator<OdLgdComputationResult>
        {
            public OdLgdComputationResultValidator(){
        ...
        {
            return new OdLgdComputationResultValidator();
        }
