...
namespace Fintrak.Client.Core.Contracts
{
    ...
    public interface IExtractionProcessService : IServiceContract
    {
        ...
        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        UploadStatus UpdateUploadStatus(UploadStatus upload);

        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        void DeleteUploadStatus(int uploadId);

        [OperationContract]
        [FaultContract(typeof(NotFoundException))]
        UploadStatus GetUploadStatus(int uploadId);

        [OperationContract]
        UploadStatus[] GetAllUploadStatuss();
        ...
        [OperationContract]
        KeyvalueModel[] BuildOptionParams(int optioncode);
