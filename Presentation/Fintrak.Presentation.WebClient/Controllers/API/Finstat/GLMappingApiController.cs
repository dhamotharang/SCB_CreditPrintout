...
namespace Fintrak.Presentation.WebClient.API
{
    ...
    public class GLMappingApiController : ApiControllerBase
    {
        ...
        [HttpGet]
        [Route("availableglMappings/{flag}")]
        public HttpResponseMessage GetAvailableGLMappings(HttpRequestMessage request, int flag)
        {
            return GetHttpResponse(request, () =>
            {
                GLMappingData[] glMappings = _FinstatService.GetGLMappings(flag);
