...
namespace Fintrak.Presentation.WebClient.API
{
    ...
    public class IfrsCorporatePdSeriesApiController : ApiControllerBase
    {
        ...
        //    return GetHttpResponse(request, () =>
        //    {
        //        Stream fileStream = _IFRS9Service.GetExportIfrsCorporatePdSeries();
        //        var response = DownloadFileService.DownloadFile(fileStream, "D:\\Application\\FintrakRevoMerg9 -- NEW\\FintrakRevoMerg9 -- FSDH\\Shared\\Fintrak.Shared.Common", "data.xlsx");
        //        return response;
        //    });
        //}
    }
