...
namespace Fintrak.Presentation.WebClient.API
{
    ...
    public class RunUploadApiController : ApiControllerBase
    {
        ...
        [HttpGet]
        [Route("getuploadwithoptions/{optcode}")]
        public HttpResponseMessage buildOptionParams(HttpRequestMessage request, int optcode) {
            return GetHttpResponse(request, () => {
                //HttpResponseMessage response = null;
                var seloptions  = _ExtractionProcessService.BuildOptionParams(optcode);
                return request.CreateResponse<KeyvalueModel[]>(HttpStatusCode.OK, seloptions);
            });
        }
        ...
        [HttpGet]
        [Route("ProcessRunJob/{id}")]
        public HttpResponseMessage processRunJob(HttpRequestMessage request, int id) {
            return GetHttpResponse(request, () => {
                var results = _ExtractionProcessService.ProcessRunJob(id);
