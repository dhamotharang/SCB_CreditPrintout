...
namespace Fintrak.Shared.Common.Services
{
    public class ExcelService
    {
        ...
        static private string filePath = HostingEnvironment.MapPath("~") + "ExportedData\\";
        ...
        public string Export<T>(List<T> tempArticles, string path)
        {
            ...
            {
                if (rowNumber % ExcelService.rowsPerSheet == 0)
                {
                    if ((rowNumber / ExcelService.rowsPerSheet) % 2 == 0)
                    {
                ...
                var sheetRow = rowNumber / ExcelService.rowsPerSheet < 1 ? rowNumber++ % ExcelService.rowsPerSheet : rowNumber++ % ExcelService.rowsPerSheet + 1;
                //Create a new Row
