...
namespace Fintrak.Business.IFRS.Managers {
    ...
    public class IFRS9Manager : ManagerBase, IIFRS9Service {
        ...
        //        Stream file = IfrsCorporatePdSeriesRepository.GetForExport();
        ...
        public HistoricalDefaultFreq[] GetAllHistoricalDefaultFreqs() {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IHistoricalDefaultFreqRepository historicaldefaultfreqRepository = _DataRepositoryFactory.GetDataRepository<IHistoricalDefaultFreqRepository>();
                IEnumerable<HistoricalDefaultFreq> historicaldefaultfreqs = historicaldefaultfreqRepository.Get().ToArray();
        ...
        public HistoricalDefaultFreq[] GetHistoricalDefaultFreqs(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IHistoricalDefaultFreqRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IHistoricalDefaultFreqRepository>();
                IEnumerable<HistoricalDefaultFreq> marginalpddstrlbs = marginalpddstrlbRepository.GetHistoricalDefaultFreqs(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public CummulativePD[] GetCummulativePDs(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ICummulativePDRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<ICummulativePDRepository>();
                IEnumerable<CummulativePD> marginalpddstrlbs = marginalpddstrlbRepository.GetCummulativePDs(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public CummulativeDefaultAmt[] GetCummulativeDefaultAmts(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ICummulativeDefaultAmtRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<ICummulativeDefaultAmtRepository>();
                IEnumerable<CummulativeDefaultAmt> marginalpddstrlbs = marginalpddstrlbRepository.GetCummulativeDefaultAmts(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public CummulativeLifetimePd[] GetCummulativeLifetimePds(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ICummulativeLifetimePdRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<ICummulativeLifetimePdRepository>();
                IEnumerable<CummulativeLifetimePd> marginalpddstrlbs = marginalpddstrlbRepository.GetCummulativeLifetimePds(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public BondsECLComputationResult[] GetBondsECLComputationResultBySearch(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                ...
                IEnumerable<BondsECLComputationResult> marginalpddstrlbs = marginalpddstrlbRepository.GetBondsECLComputationResultBySearch(searchParam);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public BondsECLComputationResult[] GetBondsECLComputationResults(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IBondsECLComputationResultRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IBondsECLComputationResultRepository>();
                IEnumerable<BondsECLComputationResult> marginalpddstrlbs = marginalpddstrlbRepository.GetBondsECLComputationResults(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public LoanECLResult[] GetLoanECLResults(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ILoanECLResultRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<ILoanECLResultRepository>();
                IEnumerable<LoanECLResult> marginalpddstrlbs = marginalpddstrlbRepository.GetLoanECLResults(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public ObeECLResult[] GetObeECLResults(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IObeECLResultRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IObeECLResultRepository>();
                IEnumerable<ObeECLResult> marginalpddstrlbs = marginalpddstrlbRepository.GetObeECLResults(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public BondsECLResult[] GetBondsECLResults(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IBondsECLResultRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IBondsECLResultRepository>();
                IEnumerable<BondsECLResult> marginalpddstrlbs = marginalpddstrlbRepository.GetBondsECLResults(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public OdECLResult[] GetOdECLResults(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IOdECLResultRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IOdECLResultRepository>();
                IEnumerable<OdECLResult> marginalpddstrlbs = marginalpddstrlbRepository.GetOdECLResults(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public ScbDataInfo UpdateScbDataInfo(ScbDataInfo scbdatainfo) {
            return ExecuteFaultHandledOperation(() => {
                ...
                IScbDataInfoRepository scbdatainfoRepository = _DataRepositoryFactory.GetDataRepository<IScbDataInfoRepository>();

                ScbDataInfo updatedEntity = null;

                if (scbdatainfo.ID == 0)
                    updatedEntity = scbdatainfoRepository.Add(scbdatainfo);
                else
                    updatedEntity = scbdatainfoRepository.Update(scbdatainfo);
        ...
        [OperationBehavior(TransactionScopeRequired = true)]
        public void DeleteScbDataInfo(int scbdatainfoId) {
            ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ...
                scbdatainfoRepository.Remove(scbdatainfoId);
            });
        }
        ...
        public ScbDataInfo GetScbDataInfo(int ID) {
            return ExecuteFaultHandledOperation(() => {
                ...
                ScbDataInfo scbdatainfoEntity = scbdatainfoRepository.Get(ID);
                if (scbdatainfoEntity == null) {
                    NotFoundException ex = new NotFoundException(string.Format("ScbDataInfo with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }

                return scbdatainfoEntity;
            });
        }
        ...
        public ScbDataInfo[] GetAllScbDataInfos() {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbDataInfoRepository scbdatainfoRepository = _DataRepositoryFactory.GetDataRepository<IScbDataInfoRepository>();
                IEnumerable<ScbDataInfo> scbdatainfos = scbdatainfoRepository.Get().ToArray();
                return scbdatainfos.ToArray();
            });
        }
        ...
        public double getScbDataInfoBalance() {
            return ExecuteFaultHandledOperation(() => {
                ...
                var connectionString = GetDataConnection();
                using (var con = new SqlConnection(connectionString)) {
                    var cmd = new SqlCommand("scb_getTotalBalance", con);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd.CommandTimeout = 0;
                    cmd.Parameters.AddWithValue("@tableName", "ifrs_ScbDataTable");
                    con.Open();
                    SqlDataReader reader = cmd.ExecuteReader();
                    while (reader.Read()) {
                        if (reader["TotalBalance"] != DBNull.Value) {
                            total = double.Parse(reader["TotalBalance"].ToString());
                        }
                    }
                    reader.Close();
                    con.Close();
        ...
        public ScbDataInfo[] GetScbDataInfoBySearch(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbDataInfoRepository scbdatainfoRepository = _DataRepositoryFactory.GetDataRepository<IScbDataInfoRepository>();
                IEnumerable<ScbDataInfo> scbdatainfos = scbdatainfoRepository.GetScbDataInfoBySearch(searchParam);
                return scbdatainfos.ToArray();
            });
        }
        ...
        public ScbDataInfo[] GetScbDataInfos(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbDataInfoRepository scbdatainfoRepository = _DataRepositoryFactory.GetDataRepository<IScbDataInfoRepository>();
                IEnumerable<ScbDataInfo> scbdatainfos = scbdatainfoRepository.GetScbDataInfos(defaultCount);
                return scbdatainfos.ToArray();
            });
        }
        ...
        public string[] GetScbOptionsByFilter(string filterParam) {
            return ExecuteFaultHandledOperation(() => {
                ...
                string[] scbdatainfos = scbdatainfoRepository.GetScbOptionsByFilter(filterParam);
        ...
        // public string updateFilteredScbDataInfo(string filterstr) {
        //    return ExecuteFaultHandledOperation(() => {
        //        var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
        //        AllowAccessToOperation(SOLUTION_NAME, groupNames);
        //        IScbDataInfoRepository scbdatainfoRepository = _DataRepositoryFactory.GetDataRepository<IScbDataInfoRepository>();
        //        string scbdatainfos = scbdatainfoRepository.updateFilteredScbDataInfo(filterstr);
        //        return scbdatainfos.ToArray();
        //    });
        //}

        public void updateFilteredScbDataInfo(string colname, string oldVal, string newVal) {

            var connectionString = GetDataConnection();

            int status = 0;
            using (var con = new SqlConnection(connectionString)) {
                var cmd = new SqlCommand("scb_updateDistinctFields", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
                cmd.Parameters.Add(new SqlParameter {
        ...
        public ScbDataInfo[] ExportScbDataInfo(int defaultCount, string path) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbDataInfoRepository scbdatainfoRepository = _DataRepositoryFactory.GetDataRepository<IScbDataInfoRepository>();
                IEnumerable<ScbDataInfo> scbdatainfos = scbdatainfoRepository.ExportScbDataInfo(defaultCount, path);
                return scbdatainfos.ToArray();
            });
        }
        ...
        #region CRLastCreditDate operations
        ...
        public CRLastCreditDate UpdateCRLastCreditDate(CRLastCreditDate crlastcreditdate) {
            return ExecuteFaultHandledOperation(() => {
                ...
                ICRLastCreditDateRepository crlastcreditdateRepository = _DataRepositoryFactory.GetDataRepository<ICRLastCreditDateRepository>();

                CRLastCreditDate updatedEntity = null;

                if (crlastcreditdate.ID == 0)
                    updatedEntity = crlastcreditdateRepository.Add(crlastcreditdate);
                else
                    updatedEntity = crlastcreditdateRepository.Update(crlastcreditdate);
        ...
        [OperationBehavior(TransactionScopeRequired = true)]
        public void DeleteCRLastCreditDate(int crlastcreditdateId) {
            ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ...
                crlastcreditdateRepository.Remove(crlastcreditdateId);
            });
        }
        ...
        public CRLastCreditDate GetCRLastCreditDate(int ID) {
            return ExecuteFaultHandledOperation(() => {
                ...
                CRLastCreditDate crlastcreditdateEntity = crlastcreditdateRepository.Get(ID);
                if (crlastcreditdateEntity == null) {
                    NotFoundException ex = new NotFoundException(string.Format("CRLastCreditDate with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }

                return crlastcreditdateEntity;
            });
        }
        ...
        public CRLastCreditDate[] GetAllCRLastCreditDates() {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ICRLastCreditDateRepository crlastcreditdateRepository = _DataRepositoryFactory.GetDataRepository<ICRLastCreditDateRepository>();
                IEnumerable<CRLastCreditDate> crlastcreditdates = crlastcreditdateRepository.Get().ToArray();
                return crlastcreditdates.ToArray();
            });
        }
        ...
        public CRLastCreditDate[] GetCRLastCreditDateBySearch(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ICRLastCreditDateRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<ICRLastCreditDateRepository>();
                IEnumerable<CRLastCreditDate> marginalpddstrlbs = marginalpddstrlbRepository.GetCRLastCreditDateBySearch(searchParam);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public CRLastCreditDate[] GetCRLastCreditDates(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ICRLastCreditDateRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<ICRLastCreditDateRepository>();
                IEnumerable<CRLastCreditDate> marginalpddstrlbs = marginalpddstrlbRepository.GetCRLastCreditDates(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        #region ScbCreditSanction operations
        ...
        public ScbCreditSanction UpdateScbCreditSanction(ScbCreditSanction scbcreditsanction) {
            return ExecuteFaultHandledOperation(() => {
                ...
                IScbCreditSanctionRepository scbcreditsanctionRepository = _DataRepositoryFactory.GetDataRepository<IScbCreditSanctionRepository>();

                ScbCreditSanction updatedEntity = null;

                if (scbcreditsanction.ID == 0)
                    updatedEntity = scbcreditsanctionRepository.Add(scbcreditsanction);
                else
                    updatedEntity = scbcreditsanctionRepository.Update(scbcreditsanction);
        ...
        [OperationBehavior(TransactionScopeRequired = true)]
        public void DeleteScbCreditSanction(int scbcreditsanctionId) {
            ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ...
                scbcreditsanctionRepository.Remove(scbcreditsanctionId);
            });
        }
        ...
        public ScbCreditSanction GetScbCreditSanction(int ID) {
            return ExecuteFaultHandledOperation(() => {
                ...
                ScbCreditSanction scbcreditsanctionEntity = scbcreditsanctionRepository.Get(ID);
                if (scbcreditsanctionEntity == null) {
                    NotFoundException ex = new NotFoundException(string.Format("ScbCreditSanction with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }

                return scbcreditsanctionEntity;
            });
        }
        ...
        public ScbCreditSanction[] GetAllScbCreditSanctions() {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbCreditSanctionRepository scbcreditsanctionRepository = _DataRepositoryFactory.GetDataRepository<IScbCreditSanctionRepository>();
                IEnumerable<ScbCreditSanction> scbcreditsanctions = scbcreditsanctionRepository.Get().ToArray();
                return scbcreditsanctions.ToArray();
            });
        }
        ...
        public ScbCreditSanction[] GetScbCreditSanctionBySearch(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbCreditSanctionRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IScbCreditSanctionRepository>();
                IEnumerable<ScbCreditSanction> marginalpddstrlbs = marginalpddstrlbRepository.GetScbCreditSanctionBySearch(searchParam);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public ScbCreditSanction[] GetScbCreditSanctions(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbCreditSanctionRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IScbCreditSanctionRepository>();
                IEnumerable<ScbCreditSanction> marginalpddstrlbs = marginalpddstrlbRepository.GetScbCreditSanctions(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        #region CreditCollateralMgt operations
        ...
        public CreditCollateralMgt UpdateCreditCollateralMgt(CreditCollateralMgt creditcollateralmgt) {
            return ExecuteFaultHandledOperation(() => {
                ...
                ICreditCollateralMgtRepository creditcollateralmgtRepository = _DataRepositoryFactory.GetDataRepository<ICreditCollateralMgtRepository>();

                CreditCollateralMgt updatedEntity = null;

                if (creditcollateralmgt.ID == 0)
                    updatedEntity = creditcollateralmgtRepository.Add(creditcollateralmgt);
                else
                    updatedEntity = creditcollateralmgtRepository.Update(creditcollateralmgt);
        ...
        [OperationBehavior(TransactionScopeRequired = true)]
        public void DeleteCreditCollateralMgt(int creditcollateralmgtId) {
            ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ...
                creditcollateralmgtRepository.Remove(creditcollateralmgtId);
            });
        }
        ...
        public CreditCollateralMgt GetCreditCollateralMgt(int ID) {
            return ExecuteFaultHandledOperation(() => {
                ...
                CreditCollateralMgt creditcollateralmgtEntity = creditcollateralmgtRepository.Get(ID);
                if (creditcollateralmgtEntity == null) {
                    NotFoundException ex = new NotFoundException(string.Format("CreditCollateralMgt with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }

                return creditcollateralmgtEntity;
            });
        }
        ...
        public CreditCollateralMgt[] GetAllCreditCollateralMgts() {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ICreditCollateralMgtRepository creditcollateralmgtRepository = _DataRepositoryFactory.GetDataRepository<ICreditCollateralMgtRepository>();
                IEnumerable<CreditCollateralMgt> creditcollateralmgts = creditcollateralmgtRepository.Get().ToArray();
                return creditcollateralmgts.ToArray();
            });
        }
        ...
        public CreditCollateralMgt[] GetCreditCollateralMgtBySearch(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ICreditCollateralMgtRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<ICreditCollateralMgtRepository>();
                IEnumerable<CreditCollateralMgt> marginalpddstrlbs = marginalpddstrlbRepository.GetCreditCollateralMgtBySearch(searchParam);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public CreditCollateralMgt[] GetCreditCollateralMgts(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ICreditCollateralMgtRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<ICreditCollateralMgtRepository>();
                IEnumerable<CreditCollateralMgt> marginalpddstrlbs = marginalpddstrlbRepository.GetCreditCollateralMgts(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        #region ScbCustomerInfo operations
        ...
        public ScbCustomerInfo UpdateScbCustomerInfo(ScbCustomerInfo scbcustomerinfo) {
            return ExecuteFaultHandledOperation(() => {
                ...
                IScbCustomerInfoRepository scbcustomerinfoRepository = _DataRepositoryFactory.GetDataRepository<IScbCustomerInfoRepository>();

                ScbCustomerInfo updatedEntity = null;

                if (scbcustomerinfo.ID == 0)
                    updatedEntity = scbcustomerinfoRepository.Add(scbcustomerinfo);
                else
                    updatedEntity = scbcustomerinfoRepository.Update(scbcustomerinfo);
        ...
        [OperationBehavior(TransactionScopeRequired = true)]
        public void DeleteScbCustomerInfo(int scbcustomerinfoId) {
            ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ...
                scbcustomerinfoRepository.Remove(scbcustomerinfoId);
            });
        }
        ...
        public ScbCustomerInfo GetScbCustomerInfo(int ID) {
            return ExecuteFaultHandledOperation(() => {
                ...
                ScbCustomerInfo scbcustomerinfoEntity = scbcustomerinfoRepository.Get(ID);
                if (scbcustomerinfoEntity == null) {
                    NotFoundException ex = new NotFoundException(string.Format("ScbCustomerInfo with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }

                return scbcustomerinfoEntity;
            });
        }
        ...
        public ScbCustomerInfo[] GetAllScbCustomerInfos() {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbCustomerInfoRepository scbcustomerinfoRepository = _DataRepositoryFactory.GetDataRepository<IScbCustomerInfoRepository>();
                IEnumerable<ScbCustomerInfo> scbcustomerinfos = scbcustomerinfoRepository.Get().ToArray();
                return scbcustomerinfos.ToArray();
            });
        }
        ...
        public ScbCustomerInfo[] GetScbCustomerInfoBySearch(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbCustomerInfoRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IScbCustomerInfoRepository>();
                IEnumerable<ScbCustomerInfo> marginalpddstrlbs = marginalpddstrlbRepository.GetScbCustomerInfoBySearch(searchParam);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public ScbCustomerInfo[] GetScbCustomerInfos(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbCustomerInfoRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IScbCustomerInfoRepository>();
                IEnumerable<ScbCustomerInfo> marginalpddstrlbs = marginalpddstrlbRepository.GetScbCustomerInfos(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        #region ScbCollateralMgt operations
        ...
        public ScbCollateralMgt UpdateScbCollateralMgt(ScbCollateralMgt scbcollateralmgt) {
            return ExecuteFaultHandledOperation(() => {
                ...
                IScbCollateralMgtRepository scbcollateralmgtRepository = _DataRepositoryFactory.GetDataRepository<IScbCollateralMgtRepository>();

                ScbCollateralMgt updatedEntity = null;

                if (scbcollateralmgt.ID == 0)
                    updatedEntity = scbcollateralmgtRepository.Add(scbcollateralmgt);
                else
                    updatedEntity = scbcollateralmgtRepository.Update(scbcollateralmgt);
        ...
        [OperationBehavior(TransactionScopeRequired = true)]
        public void DeleteScbCollateralMgt(int scbcollateralmgtId) {
            ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ...
                scbcollateralmgtRepository.Remove(scbcollateralmgtId);
            });
        }
        ...
        public ScbCollateralMgt GetScbCollateralMgt(int ID) {
            return ExecuteFaultHandledOperation(() => {
                ...
                ScbCollateralMgt scbcollateralmgtEntity = scbcollateralmgtRepository.Get(ID);
                if (scbcollateralmgtEntity == null) {
                    NotFoundException ex = new NotFoundException(string.Format("ScbCollateralMgt with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }

                return scbcollateralmgtEntity;
            });
        }
        ...
        public ScbCollateralMgt[] GetAllScbCollateralMgts() {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbCollateralMgtRepository scbcollateralmgtRepository = _DataRepositoryFactory.GetDataRepository<IScbCollateralMgtRepository>();
                IEnumerable<ScbCollateralMgt> scbcollateralmgts = scbcollateralmgtRepository.Get().ToArray();
                return scbcollateralmgts.ToArray();
            });
        }
        ...
        public ScbCollateralMgt[] GetScbCollateralMgtBySearch(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbCollateralMgtRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IScbCollateralMgtRepository>();
                IEnumerable<ScbCollateralMgt> marginalpddstrlbs = marginalpddstrlbRepository.GetScbCollateralMgtBySearch(searchParam);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public ScbCollateralMgt[] GetScbCollateralMgts(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbCollateralMgtRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IScbCollateralMgtRepository>();
                IEnumerable<ScbCollateralMgt> marginalpddstrlbs = marginalpddstrlbRepository.GetScbCollateralMgts(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        #region ScbBankClassification operations
        ...
        public ScbBankClassification UpdateScbBankClassification(ScbBankClassification scbbankclassification) {
            return ExecuteFaultHandledOperation(() => {
                ...
                IScbBankClassificationRepository scbbankclassificationRepository = _DataRepositoryFactory.GetDataRepository<IScbBankClassificationRepository>();

                ScbBankClassification updatedEntity = null;

                if (scbbankclassification.ID == 0)
                    updatedEntity = scbbankclassificationRepository.Add(scbbankclassification);
                else
                    updatedEntity = scbbankclassificationRepository.Update(scbbankclassification);
        ...
        [OperationBehavior(TransactionScopeRequired = true)]
        public void DeleteScbBankClassification(int scbbankclassificationId) {
            ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ...
                scbbankclassificationRepository.Remove(scbbankclassificationId);
            });
        }
        ...
        public ScbBankClassification GetScbBankClassification(int ID) {
            return ExecuteFaultHandledOperation(() => {
                ...
                ScbBankClassification scbbankclassificationEntity = scbbankclassificationRepository.Get(ID);
                if (scbbankclassificationEntity == null) {
                    NotFoundException ex = new NotFoundException(string.Format("ScbBankClassification with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }

                return scbbankclassificationEntity;
            });
        }
        ...
        public ScbBankClassification[] GetAllScbBankClassifications() {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbBankClassificationRepository scbbankclassificationRepository = _DataRepositoryFactory.GetDataRepository<IScbBankClassificationRepository>();
                IEnumerable<ScbBankClassification> scbbankclassifications = scbbankclassificationRepository.Get().ToArray();
                return scbbankclassifications.ToArray();
            });
        }
        ...
        public ScbBankClassification[] GetScbBankClassificationBySearch(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbBankClassificationRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IScbBankClassificationRepository>();
                IEnumerable<ScbBankClassification> marginalpddstrlbs = marginalpddstrlbRepository.GetScbBankClassificationBySearch(searchParam);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public ScbBankClassification[] GetScbBankClassifications(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbBankClassificationRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IScbBankClassificationRepository>();
                IEnumerable<ScbBankClassification> marginalpddstrlbs = marginalpddstrlbRepository.GetScbBankClassifications(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public ScbProduct UpdateScbProduct(ScbProduct scbproduct) {
            return ExecuteFaultHandledOperation(() => {
                ...
                IScbProductRepository scbproductRepository = _DataRepositoryFactory.GetDataRepository<IScbProductRepository>();

                ScbProduct updatedEntity = null;

                if (scbproduct.ID == 0)
                    updatedEntity = scbproductRepository.Add(scbproduct);
                else
                    updatedEntity = scbproductRepository.Update(scbproduct);
        ...
        [OperationBehavior(TransactionScopeRequired = true)]
        public void DeleteScbProduct(int scbproductId) {
            ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ...
                scbproductRepository.Remove(scbproductId);
            });
        }
        ...
        public ScbProduct GetScbProduct(int ID) {
            return ExecuteFaultHandledOperation(() => {
                ...
                ScbProduct scbproductEntity = scbproductRepository.Get(ID);
                if (scbproductEntity == null) {
                    NotFoundException ex = new NotFoundException(string.Format("ScbProduct with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }

                return scbproductEntity;
            });
        }
        ...
        public ScbProduct[] GetAllScbProducts() {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbProductRepository scbproductRepository = _DataRepositoryFactory.GetDataRepository<IScbProductRepository>();
                IEnumerable<ScbProduct> scbproducts = scbproductRepository.Get().ToArray();
                return scbproducts.ToArray();
            });
        }
        ...
        public ScbProduct[] GetScbProductBySearch(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbProductRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IScbProductRepository>();
                IEnumerable<ScbProduct> marginalpddstrlbs = marginalpddstrlbRepository.GetScbProductBySearch(searchParam);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public ScbProduct[] GetScbProducts(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbProductRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IScbProductRepository>();
                IEnumerable<ScbProduct> marginalpddstrlbs = marginalpddstrlbRepository.GetScbProducts(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        #region ScbException operations
        ...
        public ScbException UpdateScbException(ScbException scbexception) {
            return ExecuteFaultHandledOperation(() => {
                ...
                IScbExceptionRepository scbexceptionRepository = _DataRepositoryFactory.GetDataRepository<IScbExceptionRepository>();

                ScbException updatedEntity = null;

                if (scbexception.ID == 0)
                    updatedEntity = scbexceptionRepository.Add(scbexception);
                else
                    updatedEntity = scbexceptionRepository.Update(scbexception);
        ...
        [OperationBehavior(TransactionScopeRequired = true)]
        public void DeleteScbException(int scbexceptionId) {
            ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ...
                scbexceptionRepository.Remove(scbexceptionId);
            });
        }
        ...
        public ScbException GetScbException(int ID) {
            return ExecuteFaultHandledOperation(() => {
                ...
                ScbException scbexceptionEntity = scbexceptionRepository.Get(ID);
                if (scbexceptionEntity == null) {
                    NotFoundException ex = new NotFoundException(string.Format("ScbException with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }

                return scbexceptionEntity;
            });
        }
        ...
        public ScbException[] GetAllScbExceptions() {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbExceptionRepository scbexceptionRepository = _DataRepositoryFactory.GetDataRepository<IScbExceptionRepository>();
                IEnumerable<ScbException> scbexceptions = scbexceptionRepository.Get().ToArray();
                return scbexceptions.ToArray();
            });
        }
        ...
        public ScbException[] GetScbExceptionBySearch(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbExceptionRepository scbexceptionRepository = _DataRepositoryFactory.GetDataRepository<IScbExceptionRepository>();
                IEnumerable<ScbException> scbexceptions = scbexceptionRepository.GetScbExceptionBySearch(searchParam);
                return scbexceptions.ToArray();
            });
        }
        ...
        public ScbException[] GetScbExceptions(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbExceptionRepository scbexceptionRepository = _DataRepositoryFactory.GetDataRepository<IScbExceptionRepository>();
                IEnumerable<ScbException> scbexceptions = scbexceptionRepository.GetScbExceptions(defaultCount);
                return scbexceptions.ToArray();
            });
        }
        ...
        public ScbException[] getExceptionMessageByFilter(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbExceptionRepository scbexceptionRepository = _DataRepositoryFactory.GetDataRepository<IScbExceptionRepository>();
                IEnumerable<ScbException> scbexceptions = scbexceptionRepository.getExceptionMessageByFilter(searchParam);
                return scbexceptions.ToArray();
            });
        }
        ...
        public string[] GetDistinctScbExpMessages() {
            ...
            using (var con = new SqlConnection(connectionString)) {
                var cmd = new SqlCommand("scb_distinct_exception_msgs", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
                ...
                SqlDataReader reader = cmd.ExecuteReader();
                {
                    while (reader.Read()) {
                        ...
                        if (reader["message"] != DBNull.Value)
                            errExps.Add(reader["message"].ToString());
                            periods.RefNo = reader["message"].ToString();
                    }
                    reader.Close();
                    con.Close();
                }
        ...
        public ScbException[] RevertExceptionById(string ID) {
            ...
            using (var con = new SqlConnection(connectionString)) {
                var cmd = new SqlCommand("scb_revert_exception", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
            ...
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbExceptionRepository scbexceptionRepository = _DataRepositoryFactory.GetDataRepository<IScbExceptionRepository>();
                IEnumerable<ScbException> scbexceptions = scbexceptionRepository.GetScbExceptions(500);
                return scbexceptions.ToArray();
            });
        ...
        public ScbException[] RevertAllExceptionObjs() {
            ...
            using (var con = new SqlConnection(connectionString)) {
                var cmd = new SqlCommand("scb_revert_all_exceptions", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
        ...
        #region ScbGLBalance operations
        ...
        public ScbGLBalance UpdateScbGLBalance(ScbGLBalance scbglbalance) {
            return ExecuteFaultHandledOperation(() => {
                ...
                IScbGLBalanceRepository scbglbalanceRepository = _DataRepositoryFactory.GetDataRepository<IScbGLBalanceRepository>();

                ScbGLBalance updatedEntity = null;

                if (scbglbalance.ID == 0)
                    updatedEntity = scbglbalanceRepository.Add(scbglbalance);
                else
                    updatedEntity = scbglbalanceRepository.Update(scbglbalance);
        ...
        [OperationBehavior(TransactionScopeRequired = true)]
        public void DeleteScbGLBalance(int scbglbalanceId) {
            ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ...
                scbglbalanceRepository.Remove(scbglbalanceId);
            });
        }
        ...
        public ScbGLBalance GetScbGLBalance(int ID) {
            return ExecuteFaultHandledOperation(() => {
                ...
                ScbGLBalance scbglbalanceEntity = scbglbalanceRepository.Get(ID);
                if (scbglbalanceEntity == null) {
                    NotFoundException ex = new NotFoundException(string.Format("ScbGLBalance with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }

                return scbglbalanceEntity;
            });
        }
        ...
        public ScbGLBalance[] GetAllScbGLBalances() {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbGLBalanceRepository scbglbalanceRepository = _DataRepositoryFactory.GetDataRepository<IScbGLBalanceRepository>();
                IEnumerable<ScbGLBalance> scbglbalances = scbglbalanceRepository.Get().ToArray();
                return scbglbalances.ToArray();
            });
        }
        ...
        public ScbGLBalance[] GetScbGLBalanceBySearch(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbGLBalanceRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IScbGLBalanceRepository>();
                IEnumerable<ScbGLBalance> marginalpddstrlbs = marginalpddstrlbRepository.GetScbGLBalanceBySearch(searchParam);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public ScbGLBalance[] GetScbGLBalances(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbGLBalanceRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IScbGLBalanceRepository>();
                IEnumerable<ScbGLBalance> marginalpddstrlbs = marginalpddstrlbRepository.GetScbGLBalances(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        #region ScbDataTBValidated operations
        ...
        public ScbDataTBValidated UpdateScbDataTBValidated(ScbDataTBValidated scbdatatbvalidated) {
            return ExecuteFaultHandledOperation(() => {
                ...
                IScbDataTBValidatedRepository scbdatatbvalidatedRepository = _DataRepositoryFactory.GetDataRepository<IScbDataTBValidatedRepository>();

                ScbDataTBValidated updatedEntity = null;

                if (scbdatatbvalidated.ID == 0)
                    updatedEntity = scbdatatbvalidatedRepository.Add(scbdatatbvalidated);
                else
                    updatedEntity = scbdatatbvalidatedRepository.Update(scbdatatbvalidated);
        ...
        [OperationBehavior(TransactionScopeRequired = true)]
        public void DeleteScbDataTBValidated(int scbdatatbvalidatedId) {
            ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbDataTBValidatedRepository scbdatatbvalidatedRepository = _DataRepositoryFactory.GetDataRepository<IScbDataTBValidatedRepository>();
                scbdatatbvalidatedRepository.Remove(scbdatatbvalidatedId);
            });
        }
        ...
        public ScbDataTBValidated GetScbDataTBValidated(int ID) {
            return ExecuteFaultHandledOperation(() => {
                ...
                ScbDataTBValidated scbdatatbvalidatedEntity = scbdatatbvalidatedRepository.Get(ID);
                if (scbdatatbvalidatedEntity == null) {
                    NotFoundException ex = new NotFoundException(string.Format("ScbDataTBValidated with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }

                return scbdatatbvalidatedEntity;
            });
        }
        ...
        public ScbDataTBValidated[] GetAllScbDataTBValidateds() {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbDataTBValidatedRepository scbdatatbvalidatedRepository = _DataRepositoryFactory.GetDataRepository<IScbDataTBValidatedRepository>();
                IEnumerable<ScbDataTBValidated> scbdatatbvalidateds = scbdatatbvalidatedRepository.Get().ToArray();
                return scbdatatbvalidateds.ToArray();
            });
        }
        ...
        public ScbDataTBValidated[] GetScbDataTBValidatedBySearch(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbDataTBValidatedRepository scbdatatbvalidatedRepository = _DataRepositoryFactory.GetDataRepository<IScbDataTBValidatedRepository>();
                IEnumerable<ScbDataTBValidated> scbdatatbvalidateds = scbdatatbvalidatedRepository.GetScbDataTBValidatedBySearch(searchParam);
                return scbdatatbvalidateds.ToArray();
            });
        }
        ...
        public ScbDataTBValidated[] GetScbDataTBValidateds(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbDataTBValidatedRepository scbdatatbvalidatedRepository = _DataRepositoryFactory.GetDataRepository<IScbDataTBValidatedRepository>();
                IEnumerable<ScbDataTBValidated> scbdatatbvalidateds = scbdatatbvalidatedRepository.GetScbDataTBValidateds(defaultCount);
                return scbdatatbvalidateds.ToArray();
            });
        }
        ...
        public double getScbDataTBValidatedBalance() {
            return ExecuteFaultHandledOperation(() => {
                ...
                using (var con = new SqlConnection(connectionString)) {
                    ...
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd.CommandTimeout = 0;
                    cmd.Parameters.AddWithValue("@tableName", "ifrs_ScbDataTable_validated");
                    con.Open();
                    SqlDataReader reader = cmd.ExecuteReader();
                    while (reader.Read()) {
                        if (reader["TotalBalance"] != DBNull.Value) {
        ...
        public string[] GetScbDataTBOptionsByFilter(string filterParam) {
            return ExecuteFaultHandledOperation(() => {
                ...
                string[] scbdatatbvalidateds = scbdatatbvalidatedRepository.GetScbDataTBOptionsByFilter(filterParam);
        ...
        // public string updateFilteredScbDataTBValidated(string filterstr) {
        //    return ExecuteFaultHandledOperation(() => {
        //        var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
        //        AllowAccessToOperation(SOLUTION_NAME, groupNames);
        //        IScbDataTBValidatedRepository scbdatatbvalidatedRepository = _DataRepositoryFactory.GetDataRepository<IScbDataTBValidatedRepository>();
        //        string scbdatatbvalidateds = scbdatatbvalidatedRepository.updateFilteredScbDataTBValidated(filterstr);
        //        return scbdatatbvalidateds.ToArray();
        //    });
        //}

        //public void updateFilteredScbDataTBValidated(string colname, string oldVal, string newVal) {
       ...
       // }
        ...
        public ScbDataTBValidated[] GetScbDataTBValidatedsByRange(double minValue, double maxValue) {
            return ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbDataTBValidatedRepository scbdatatbvalidatedRepository = _DataRepositoryFactory.GetDataRepository<IScbDataTBValidatedRepository>();
                IEnumerable<ScbDataTBValidated> scbdatatbvalidateds = scbdatatbvalidatedRepository.GetScbDataTBValidatedsByRange(minValue, maxValue);
                return scbdatatbvalidateds.ToArray();
            });
        }
        ...
        public ScbDataTBValidated[] ExportScbDataTBValidated(int defaultCount, string path) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbDataTBValidatedRepository scbdatatbvalidatedRepository = _DataRepositoryFactory.GetDataRepository<IScbDataTBValidatedRepository>();
                IEnumerable<ScbDataTBValidated> scbdatatbvalidateds = scbdatatbvalidatedRepository.ExportScbDataTBValidated(defaultCount, path);
                return scbdatatbvalidateds.ToArray();
            });
        }
        ...
        #region PfBalanceValidation operations

        [OperationBehavior(TransactionScopeRequired = true)]
        public PfBalanceValidation UpdatePfBalanceValidation(PfBalanceValidation pfbalancevalidation) {
            return ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);

                IPfBalanceValidationRepository pfbalancevalidationRepository = _DataRepositoryFactory.GetDataRepository<IPfBalanceValidationRepository>();

                PfBalanceValidation updatedEntity = null;

                if (pfbalancevalidation.ID == 0)
                    updatedEntity = pfbalancevalidationRepository.Add(pfbalancevalidation);
                else
                    updatedEntity = pfbalancevalidationRepository.Update(pfbalancevalidation);
        ...
        [OperationBehavior(TransactionScopeRequired = true)]
        public void DeletePfBalanceValidation(int pfbalancevalidationId) {
            ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ...
                pfbalancevalidationRepository.Remove(pfbalancevalidationId);
            });
        }
        ...
        public PfBalanceValidation GetPfBalanceValidation(int ID) {
            return ExecuteFaultHandledOperation(() => {
                ...
                PfBalanceValidation pfbalancevalidationEntity = pfbalancevalidationRepository.Get(ID);
                if (pfbalancevalidationEntity == null) {
                    NotFoundException ex = new NotFoundException(string.Format("PfBalanceValidation with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }

                return pfbalancevalidationEntity;
            });
        }
        ...
        public PfBalanceValidation[] GetAllPfBalanceValidations() {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IPfBalanceValidationRepository pfbalancevalidationRepository = _DataRepositoryFactory.GetDataRepository<IPfBalanceValidationRepository>();
                IEnumerable<PfBalanceValidation> pfbalancevalidations = pfbalancevalidationRepository.Get().ToArray();
                return pfbalancevalidations.ToArray();
            });
        }
        ...
        public PfBalanceValidation[] GetPfBalanceValidationBySearch(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IPfBalanceValidationRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IPfBalanceValidationRepository>();
                IEnumerable<PfBalanceValidation> marginalpddstrlbs = marginalpddstrlbRepository.GetPfBalanceValidationBySearch(searchParam);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public PfBalanceValidation[] GetPfBalanceValidations(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IPfBalanceValidationRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IPfBalanceValidationRepository>();
                IEnumerable<PfBalanceValidation> marginalpddstrlbs = marginalpddstrlbRepository.GetPfBalanceValidations(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public string[] GetDistinctScbPfBalances() {
            ...
            using (var con = new SqlConnection(connectionString)) {
                var cmd = new SqlCommand("scb_distinct_pfbalances", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
                ...
                SqlDataReader reader = cmd.ExecuteReader();
                {
                    while (reader.Read()) {
                        ...
                        if (reader["Productcode"] != DBNull.Value)
                            errExps.Add(reader["Productcode"].ToString());
                        periods.RefNo = reader["Productcode"].ToString();
                    }
                    reader.Close();
                    con.Close();
                }
      ...
      public string[] GetDistinctScbGLCodes() {
            ...
            using (var con = new SqlConnection(connectionString)) {
                var cmd = new SqlCommand("scb_distinct_scb_gl_codes", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
                ...
                SqlDataReader reader = cmd.ExecuteReader();
                {
                    while (reader.Read()) {
                        ...
                        if (reader["Glcode"] != DBNull.Value)
                            errExps.Add(reader["Glcode"].ToString());
                        periods.RefNo = reader["Glcode"].ToString();
                    }
                    reader.Close();
                    con.Close();
                }
        ...
        public PfBalanceValidation[] GetPfBalanceValidationList(string code, string name){ 
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IPfBalanceValidationRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IPfBalanceValidationRepository>();
                IEnumerable<PfBalanceValidation> marginalpddstrlbs = marginalpddstrlbRepository.GetPfBalanceValidationList(code, name); 
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        #region SCBThrownOutPSFAcc operations

        [OperationBehavior(TransactionScopeRequired = true)]
        public SCBThrownOutPSFAcc UpdateSCBThrownOutPSFAcc(SCBThrownOutPSFAcc scbthrownoutpsfacc) {
            return ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);

                ISCBThrownOutPSFAccRepository scbthrownoutpsfaccRepository = _DataRepositoryFactory.GetDataRepository<ISCBThrownOutPSFAccRepository>();

                SCBThrownOutPSFAcc updatedEntity = null;

                if (scbthrownoutpsfacc.ID == 0)
                    updatedEntity = scbthrownoutpsfaccRepository.Add(scbthrownoutpsfacc);
                else
                    updatedEntity = scbthrownoutpsfaccRepository.Update(scbthrownoutpsfacc);
        ...
        [OperationBehavior(TransactionScopeRequired = true)]
        public void DeleteSCBThrownOutPSFAcc(int scbthrownoutpsfaccId) {
            ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ...
                scbthrownoutpsfaccRepository.Remove(scbthrownoutpsfaccId);
            });
        }
        ...
        public SCBThrownOutPSFAcc GetSCBThrownOutPSFAcc(int ID) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ISCBThrownOutPSFAccRepository scbthrownoutpsfaccRepository = _DataRepositoryFactory.GetDataRepository<ISCBThrownOutPSFAccRepository>();
                SCBThrownOutPSFAcc scbthrownoutpsfaccEntity = scbthrownoutpsfaccRepository.Get(ID);
                if (scbthrownoutpsfaccEntity == null) {
                    NotFoundException ex = new NotFoundException(string.Format("SCBThrownOutPSFAcc with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }
                return scbthrownoutpsfaccEntity;
            });
        }
        ...
        public SCBThrownOutPSFAcc[] GetAllSCBThrownOutPSFAccs() {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ISCBThrownOutPSFAccRepository scbthrownoutpsfaccRepository = _DataRepositoryFactory.GetDataRepository<ISCBThrownOutPSFAccRepository>();
                IEnumerable<SCBThrownOutPSFAcc> scbthrownoutpsfaccs = scbthrownoutpsfaccRepository.Get().ToArray();
                return scbthrownoutpsfaccs.ToArray();
            });
        }
        ...
        public SCBThrownOutPSFAcc[] GetSCBThrownOutPSFAccBySearch(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ISCBThrownOutPSFAccRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<ISCBThrownOutPSFAccRepository>();
                IEnumerable<SCBThrownOutPSFAcc> marginalpddstrlbs = marginalpddstrlbRepository.GetSCBThrownOutPSFAccBySearch(searchParam);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public SCBThrownOutPSFAcc[] GetSCBThrownOutPSFAccs(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ISCBThrownOutPSFAccRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<ISCBThrownOutPSFAccRepository>();
                IEnumerable<SCBThrownOutPSFAcc> marginalpddstrlbs = marginalpddstrlbRepository.GetSCBThrownOutPSFAccs(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public ScbLimitDef UpdateScbLimitDef(ScbLimitDef scblimitdef) {
            return ExecuteFaultHandledOperation(() => {
                ...
                IScbLimitDefRepository scblimitdefRepository = _DataRepositoryFactory.GetDataRepository<IScbLimitDefRepository>();

                ScbLimitDef updatedEntity = null;

                if (scblimitdef.ID == 0)
                    updatedEntity = scblimitdefRepository.Add(scblimitdef);
                else
                    updatedEntity = scblimitdefRepository.Update(scblimitdef);
        ...
        [OperationBehavior(TransactionScopeRequired = true)]
        public void DeleteScbLimitDef(int scblimitdefId) {
            ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ...
                scblimitdefRepository.Remove(scblimitdefId);
            });
        }
        ...
        public ScbLimitDef GetScbLimitDef(int ID) {
            return ExecuteFaultHandledOperation(() => {
                ...
                ScbLimitDef scblimitdefEntity = scblimitdefRepository.Get(ID);
                if (scblimitdefEntity == null) {
                    NotFoundException ex = new NotFoundException(string.Format("ScbLimitDef with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }

                return scblimitdefEntity;
            });
        }
        ...
        public ScbLimitDef[] GetAllScbLimitDefs() {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbLimitDefRepository scblimitdefRepository = _DataRepositoryFactory.GetDataRepository<IScbLimitDefRepository>();
                IEnumerable<ScbLimitDef> scblimitdefs = scblimitdefRepository.Get().ToArray();
                return scblimitdefs.ToArray();
            });
        }
        ...
        public ScbLimitDef[] GetScbLimitDefBySearch(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbLimitDefRepository scblimitdefRepository = _DataRepositoryFactory.GetDataRepository<IScbLimitDefRepository>();
                IEnumerable<ScbLimitDef> scblimitdefs = scblimitdefRepository.GetScbLimitDefBySearch(searchParam);
                return scblimitdefs.ToArray();
            });
        }
        ...
        public ScbLimitDef[] GetScbLimitDefs(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbLimitDefRepository scblimitdefRepository = _DataRepositoryFactory.GetDataRepository<IScbLimitDefRepository>();
                IEnumerable<ScbLimitDef> scblimitdefs = scblimitdefRepository.GetScbLimitDefs(defaultCount);
                return scblimitdefs.ToArray();
            });
        }
        ...
        #region ScbBusinessSegment operations
        ...
        public ScbBusinessSegment UpdateScbBusinessSegment(ScbBusinessSegment scbbusinesssegment) {
            return ExecuteFaultHandledOperation(() => {
                ...
                IScbBusinessSegmentRepository scbbusinesssegmentRepository = _DataRepositoryFactory.GetDataRepository<IScbBusinessSegmentRepository>();

                ScbBusinessSegment updatedEntity = null;

                if (scbbusinesssegment.ID == 0)
                    updatedEntity = scbbusinesssegmentRepository.Add(scbbusinesssegment);
                else
                    updatedEntity = scbbusinesssegmentRepository.Update(scbbusinesssegment);
        ...
        [OperationBehavior(TransactionScopeRequired = true)]
        public void DeleteScbBusinessSegment(int scbbusinesssegmentId) {
            ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                ...
                scbbusinesssegmentRepository.Remove(scbbusinesssegmentId);
            });
        }
        ...
        public ScbBusinessSegment GetScbBusinessSegment(int ID) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbBusinessSegmentRepository scbbusinesssegmentRepository = _DataRepositoryFactory.GetDataRepository<IScbBusinessSegmentRepository>();
                ScbBusinessSegment scbbusinesssegmentEntity = scbbusinesssegmentRepository.Get(ID);
                if (scbbusinesssegmentEntity == null) {
                    NotFoundException ex = new NotFoundException(string.Format("ScbBusinessSegment with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }
                return scbbusinesssegmentEntity;
            });
        }
        ...
        public ScbBusinessSegment[] GetAllScbBusinessSegments() {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbBusinessSegmentRepository scbbusinesssegmentRepository = _DataRepositoryFactory.GetDataRepository<IScbBusinessSegmentRepository>();
                IEnumerable<ScbBusinessSegment> scbbusinesssegments = scbbusinesssegmentRepository.Get().ToArray();
                return scbbusinesssegments.ToArray();
            });
        }
        ...
        public ScbBusinessSegment[] GetScbBusinessSegmentBySearch(string searchParam) {
            return ExecuteFaultHandledOperation(() => {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbBusinessSegmentRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IScbBusinessSegmentRepository>();
                IEnumerable<ScbBusinessSegment> marginalpddstrlbs = marginalpddstrlbRepository.GetScbBusinessSegmentBySearch(searchParam);
                return marginalpddstrlbs.ToArray();
            });
        }
        ...
        public ScbBusinessSegment[] GetScbBusinessSegments(int defaultCount) {
            return ExecuteFaultHandledOperation(() => {
                ...
                AllowAccessToOperation(SOLUTION_NAME, groupNames);
                IScbBusinessSegmentRepository marginalpddstrlbRepository = _DataRepositoryFactory.GetDataRepository<IScbBusinessSegmentRepository>();
                IEnumerable<ScbBusinessSegment> marginalpddstrlbs = marginalpddstrlbRepository.GetScbBusinessSegments(defaultCount);
                return marginalpddstrlbs.ToArray();
            });
        }
