...
namespace Fintrak.Data.Core
{
    public class CoreContext : DbContext
    {
        ...
        public DbSet<UploadStatus> UploadStatusSet { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            //UploadStatus
            modelBuilder.Entity<UploadStatus>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<UploadStatus>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<UploadStatus>().ToTable("cor_upload_status");
