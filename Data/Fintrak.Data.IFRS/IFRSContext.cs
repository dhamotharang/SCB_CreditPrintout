...
namespace Fintrak.Data.IFRS
{
    public class IFRSContext : DbContext
    {
        ...
        public DbSet<ScbDataInfo> ScbDataInfo { get; set; }
        public DbSet<CRLastCreditDate> CRLastCreditDate { get; set; }
        public DbSet<ScbCreditSanction> ScbCreditSanction { get; set; }
        public DbSet<CreditCollateralMgt> CreditCollateralMgt { get; set; }
        public DbSet<ScbCustomerInfo> ScbCustomerInfo { get; set; }


        public DbSet<ScbDataTBValidated> ScbDataTBValidated { get; set; }


        public DbSet<ScbCollateralMgt> ScbCollateralMgt { get; set; }
        public DbSet<ScbBankClassification> ScbBankClassification { get; set; }


        public DbSet<ScbProduct> ScbProduct { get; set; }
        public DbSet<ScbException> ScbException { get; set; }
        public DbSet<ScbGLBalance> ScbGLBalance { get; set; }

        public DbSet<PfBalanceValidation> PfBalanceValidation { get; set; }


        public DbSet<SCBThrownOutPSFAcc> SCBThrownOutPSFAcc { get; set; }
        public DbSet<ScbBusinessSegment> ScbBusinessSegment { get; set; }
        public DbSet<ScbLimitDef> ScbLimitDef { get; set; }
        ...
        public DbSet<OdLgdComputationResult> OdLgdComputationResultSet { get; set; }
        ...
        public DbSet<LoansECLComputationResult> LoansECLComputationResultSet { get; set; }
        ...
        //public DbSet<RawLoanDetailsABP> LoanDetailsABPSet { get; set; }
        //public DbSet<IFRSBondsABP> IFRSBondsABPSet { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ScbDataInfo>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<ScbDataInfo>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<ScbDataInfo>().ToTable("ifrs_ScbDataTable");


            modelBuilder.Entity<CRLastCreditDate>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<CRLastCreditDate>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<CRLastCreditDate>().ToTable("ifrs_scb_crLast_Credit_date");


            modelBuilder.Entity<ScbCreditSanction>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<ScbCreditSanction>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<ScbCreditSanction>().ToTable("ifrs_scb_credit_sanction");


            modelBuilder.Entity<CreditCollateralMgt>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<CreditCollateralMgt>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<CreditCollateralMgt>().ToTable("ifrs_scb_credit_collateral_mgt");


            modelBuilder.Entity<ScbCustomerInfo>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<ScbCustomerInfo>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<ScbCustomerInfo>().ToTable("ifrs_scb_customers_information");



            // new tables... .........

            modelBuilder.Entity<ScbDataTBValidated>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<ScbDataTBValidated>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<ScbDataTBValidated>().ToTable("ifrs_ScbDataTable_validated");




            modelBuilder.Entity<ScbCollateralMgt>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<ScbCollateralMgt>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<ScbCollateralMgt>().ToTable("ifrs_scb_collateral_mgt");


            modelBuilder.Entity<ScbBankClassification>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<ScbBankClassification>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<ScbBankClassification>().ToTable("ifrs_scb_bank_classification");


            // new tables... .........

            modelBuilder.Entity<ScbProduct>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<ScbProduct>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<ScbProduct>().ToTable("ifrs_scb_products");


            modelBuilder.Entity<ScbException>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<ScbException>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<ScbException>().ToTable("ifrs_scb_exceptions");


            modelBuilder.Entity<ScbLimitDef>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<ScbLimitDef>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<ScbLimitDef>().ToTable("ifrs_scb_limit_def");


            modelBuilder.Entity<ScbGLBalance>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<ScbGLBalance>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<ScbGLBalance>().ToTable("ifrs_scb_gl_balances");


            modelBuilder.Entity<PfBalanceValidation>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<PfBalanceValidation>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<PfBalanceValidation>().ToTable("ifrs_scb_PfBalance_validation");
            ...
            modelBuilder.Entity<SCBThrownOutPSFAcc>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<SCBThrownOutPSFAcc>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<SCBThrownOutPSFAcc>().ToTable("ifrs_scb_thrown_outpsfacc");


            modelBuilder.Entity<ScbBusinessSegment>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<ScbBusinessSegment>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<ScbBusinessSegment>().ToTable("ifrs_scb_business_segment");
            ...
            //OdLgdComputationResult
            modelBuilder.Entity<OdLgdComputationResult>().HasKey<int>(e => e.Id).Ignore(e => e.EntityId);
            modelBuilder.Entity<OdLgdComputationResult>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<OdLgdComputationResult>().ToTable("ifrs_OD_lgd_computation_result");
            ...
            modelBuilder.Entity<InvestmentMarginalPd>().ToTable("ifrs_Investment_MarginalPD_STRLB_Display");
